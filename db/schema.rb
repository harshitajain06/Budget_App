...
ActiveRecord::Schema[7.0].define(version: 2023_04_25_161721) do
  ...
  create_table "categories_transacs", id: false, force: :cascade do |t|
    t.bigint "category_id", null: false
    t.bigint "transac_id", null: false
    t.index ["category_id", "transac_id"], name: "index_categories_transacs_on_category_id_and_transac_id"
  end
